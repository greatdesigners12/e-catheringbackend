...
func main() {
	...
	r.HandleFunc("/getAllPaidGroup/{user_id}", transactioncontroller.GetAllPaidGroups).Methods("GET") 
	...
	rCathering.HandleFunc("/createCathering", catheringcontroller.CreateCathering).Methods("POST")
